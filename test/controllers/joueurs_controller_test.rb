...
class JoueursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create joueur" do
    assert_difference("Joueur.count") do
      post joueurs_url, params: { joueur: { age: @joueur.age, club: @joueur.club, name: @joueur.name, position: @joueur.position } }
    end
  ...
  test "should update joueur" do
    patch joueur_url(@joueur), params: { joueur: { age: @joueur.age, club: @joueur.club, name: @joueur.name, position: @joueur.position } }
